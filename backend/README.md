...
## Project Structure
    ...
    ├── testapiautocatalog_120103  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_120103`
...
2. Clone this repo and `cd testapiautocatalog_120103`
